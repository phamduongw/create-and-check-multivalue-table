...
-- Người thay đổi	:
-- Phiên bản 		  :
-- Mô tả			    : Stream sink/transform dữ liệu trước khi đẩy xuống ODS

CREATE OR REPLACE STREAM ODS_{TABLE_NAME} WITH ( PARTITIONS=16, REPLICAS=3, RETENTION_MS=1814400000) AS SELECT
  DATA.ROWKEY ROWKEY,
